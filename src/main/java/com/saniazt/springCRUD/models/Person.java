...
public class Person {
    ...
    public boolean equals(Object o) {
        ...
        return id == person.id && age == person.age && Objects.equals(name, person.name) && Objects.equals(email, person.email) && Objects.equals(dateOfBirth, person.dateOfBirth) && mood == person.mood && Objects.equals(createdAt, person.createdAt) && Objects.equals(address, person.address);
    }

    @Override
    public int hashCode() {
        return Objects.hash(id, name, age, email, dateOfBirth, mood, createdAt, address);
    }
}
